...
<html>
  <head>
    ...
    <title>admin/showUList.jsp</title>
  ...
  <body>
    <center>
		...
		<hr>
		<form method="post" action="${pageContext.request.contextPath}/superadmin/searchforsul.action?qno=${ requestScope.qno }">
			...
			<tr>
				...
				|共${ requestScope.upageVO.pageCount}页|
					<c:choose>
						...
						<c:otherwise>
							<a href="${pageContext.request.contextPath }/admin/${requestScope.actionName }.action?page=${ requestScope.upageVO.page - 1 }">上一页</a>
						</c:otherwise>
					</c:choose> 
					...
					<c:choose>
						...
						<c:otherwise>
						<a href="${pageContext.request.contextPath }/admin/${requestScope.actionName }.action?page=${ requestScope.upageVO.page +1 }">下一页</a>
						</c:otherwise>
					</c:choose>
					</form></td>
			</tr>
