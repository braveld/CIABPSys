...
<style>
  ...
  <body>
     <center>
		...
		<hr>
		<form method="post" action="${pageContext.request.contextPath}/admin/adwritelc.action?no=${requestScope.no}&page=${requestScope.page}" enctype="multipart/form-data">
		...
		<input type="submit" value="提交" style="height:28px; width:60px; ">
		</form>
	</center>
  </body>
</html>
