...
<body align="center" scroll="no" bgcolor="#e3efff">
	<form  method="post" name="loginForm" action="${pageContext.request.contextPath}/user/register1.action" align="center">  
							...
							<td><table border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td><input name="user.mphone" type="text" id="user.mphone"
											class="inputbox" style="width:160px;hight:20px" onblur="return phoneInfoOnBlur(this);"><span id ="phoneInfo"></span></td>
									</tr>
									<tr>
										<td><span style="font-size:12px;">*用户名：</span></td>
										<td><input name="user.nick" type="text" class="inputbox" id="user.nick" onBlur="validate(this.value);"style="width:160px;hight:20px"></td>
									</tr>
									<tr>
									...
									<tr>
										<td height="100" colspan="2" valign="top"><table
												...
												<tr>
													<td><input type="submit" value="录入" onclick="getcanshu('admin/login')"
