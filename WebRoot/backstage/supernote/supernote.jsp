...
<html>
  ...
  <body>
    <center>
		...
		<hr>
    	<form action="${pageContext.request.contextPath}/superadmin/addTnote.action?tnote.no=${requestScope.user.no}" method="post" enctype="multipart/form-data">
    	...
    	<div>
			<textarea name="tnote.content" id="tnote.content" cols=150 rows=4 style="width: 900px;height: 100px" ></textarea>
		</div>
