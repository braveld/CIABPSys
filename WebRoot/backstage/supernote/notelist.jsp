...
<html>
  <head>
    ...
    <center>
		...
		<hr>
		<form method="post" action="${pageContext.request.contextPath}/superadmin/searchlcbyuser1.action">
		...
		<table border="1" width="1100" cellpadding="0" cellspacing="0" bordercolor="#1F85B6">
			<tr height="40" align="center">
				...
				<th width="100" style="color:#1F85B6">发送消息</th>
			...
			<c:forEach items="${ requestScope.upageVO.list }" var="user">
				<tr align="center">
					...
					<td><form method="post"  action="${pageContext.request.contextPath}/superadmin/noteshowByNo.action?&no=${user.no}"><input type="submit" value="发送消息" 
