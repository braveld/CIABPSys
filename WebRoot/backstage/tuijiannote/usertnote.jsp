...
<html>
  <head>
    ...
    <title>tuijiannote/usernote.jsp</title>
		...
		<table border="1" width="1100" cellpadding="0" cellspacing="0" bordercolor="#1F85B6">
			...
			<c:forEach items="${ requestScope.upageVO.list }" var="tnote">
				<tr align="center">
					...
					<td><form method="post"  action="${pageContext.request.contextPath}/user/showByTno.action?&no=${tnote.no}"><input type="submit" value="查看" 
