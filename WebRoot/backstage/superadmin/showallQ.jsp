...
<html>
  <head>
    ...
    <title>superadmin/showallQ.jsp</title>
    ...
    <center>
		...
		<table border="1" width="900" cellpadding="0" cellspacing="0" bordercolor="#1F85B6">
			...
			<tr height="40" align="center">
				...
				<th width="100" style="color:#1F85B6">问卷统计</th>
			</tr>
			</thead>
			<tbody>
			<c:forEach items="${ requestScope.pageVO.list }" var="qDetail">
				<tr align="center" height="40">
					...
					<td><form method="post" action="${pageContext.request.contextPath}/user/resultshow.action?no=${qDetail.no }"><input type="submit" value="问卷统计" style="margin-top: 20"></form></td>
				</tr>
			...
			<tfoot>
			<tr>
				<td colspan="6" align="right">当前是第${requestScope.pageVO.page }页
				|共${ requestScope.pageVO.pageCount}页|
					...
					|
					<c:forEach begin="1" end="${ requestScope.pageVO.pageCount}" var="countindex">
