...
<html>
  <head>
    ...
    <title>superadmin/showallu.jsp</title>
  ...
  <body>
   <center>
		...
		<hr>
		<form method="post" action="${pageContext.request.contextPath}/superadmin/searchforssau.action">
		...
		<table border="1" width="900" cellpadding="0" cellspacing="0" bordercolor="#1F85B6">
			...
			<tr height="40" align="center">
				...
				<th width="400" style="color:#1F85B6">真实姓名</th>
			...
			<c:forEach items="${ requestScope.upageVO.list }" var="user">
				<tr align="center" height="40">
					...
					<td>${user.nick }</td>
					<td>${user.name }</td>
					<td><form method="post" action="${pageContext.request.contextPath}/admin/showByNo.action?&no=${user.no}"><input type="submit" value="查看" ></form>
					</td>
				</tr>				
			</c:forEach>
			<tbody>
		...
		<a href="${pageContext.request.contextPath}/superadmin/download.action?fileName=userlist.xls">下载用户信息</a>
	</center>
  </body>
</html>
