						...
						<tr>
							<td><table border="1" align="center" cellpadding="0"
									...
									<tr>
										...
										<td><input name="date" id="date" type="text" class="inputbox" style="width:100px" onfocus="HS_setDate(this)" value="${requestScope.user.birthday}"></td>
									</tr>
									<tr>
									...
									<tr>
										<td height="100" colspan="2" valign="top"><table
												...
												<tr>
													<td><form method="post" action=""><input type="submit" value="保存" 
															style="height:28px; width:60px; margin-left:50px;"></form>
													</td>
												</tr>
											</table></td>
									</tr>
